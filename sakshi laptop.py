...
#=======================frame====================================================================================
        ...
        Framebutton1.place(x=150,y=420,width=314,height=57)

        Framebutton2=Frame(self.root,bd=12,relief=RIDGE,padx=0,bg="RED")
        Framebutton2.place(x=690,y=420,width=314,height=57)

        btnAddData=Button(Framebutton1,command=self.manager,text="MANAGER",font=("arial",12,"bold"),width=28,bg="#3D405B",fg="WHITE")
        btnAddData.grid(row=0,column=1,sticky=W)

        btnAddData=Button(Framebutton2,command=self.driver,text="DRIVER",font=("arial",12,"bold"),width=28,bg="#3D405B",fg="WHITE")
...
#=======================frame====================================================================================
        ...
        Framebutton1=Frame(self.root,bd=9,relief=RIDGE,padx=0,bg="blue")
        Framebutton1.place(x=400,y=200,width=365,height=46)

        Framebutton2=Frame(self.root,bd=9,relief=RIDGE,padx=0,bg="yellow")
        Framebutton2.place(x=400,y=270,width=365,height=46)

        Framebutton3=Frame(self.root,bd=9,relief=RIDGE,padx=0,bg="red")
        Framebutton3.place(x=400,y=340,width=365,height=46)

        Framebutton4=Frame(self.root,bd=9,relief=RIDGE,padx=0,bg="green")
        Framebutton4.place(x=400,y=410,width=365,height=46)

        Framebutton5=Frame(self.root,bd=9,relief=RIDGE,padx=0,bg="#2F3651")
        Framebutton5.place(x=400,y=480,width=365,height=46)

        btnAddData=Button(Framebutton1,command=self.map,text="PARKING SPOTS NEAR YOU",font=("arial",10,"bold"),width=42,bg="#3C3D50",fg="white")
        btnAddData.grid(row=0,column=1,sticky=W)

        btnAddData=Button(Framebutton2,command=self.bookspot,text="BOOK YOUR SPOT",font=("arial",10,"bold"),width=42,bg="#46332E",fg="white")
        btnAddData.grid(row=0,column=3)

        btnAddData=Button(Framebutton3,command=self.membership,text="MEMBERSHIP DETAILS",font=("arial",10,"bold"),width=42,bg="#9A7CF8",fg="white")
        btnAddData.grid(row=0,column=3)

        btnAddData=Button(Framebutton4,command=self.complaint,text="FILE A COMPLAINT",font=("arial",10,"bold"),width=42,bg="#2F3651",fg="white")
        btnAddData.grid(row=0,column=3)

        btnAddData=Button(Framebutton5,command=self.iExit,text="EXIT",font=("arial",10,"bold"),width=42,bg="#2A86FF",fg="white")
        btnAddData.grid(row=0,column=3)
...
class Book:
    def __init__(self,root):
        ...
        frame=Frame(self.root,bd=12,relief=RIDGE,padx=10,bg="#83bbc8")
        frame.place(x=350,y=200,width=515,height=275)
        ...
        Framebutton=Frame(self.root,bd=10,relief=RIDGE,padx=0,bg="blue")
        Framebutton.place(x=490,y=500,width=231,height=49)

        btnAddData=Button(Framebutton,command=self.adda_data,text="BOOK SLOT",font=("arial",10,"bold"),width=25,bg="#2F3651",fg="white")
...
class Map:
    def __init__(self,root_tk):
        ...
        Framebutton2.place(x=500,y=650,width=240,height=43)
...
class Book:
    def __init__(self,root):
        ...
        frame=Frame(self.root,bd=12,relief=RIDGE,padx=5,bg="#83bbc8")
        frame.place(x=50,y=250,width=1050,height=305)

        #================DataFrameLeft==================

        DataFrameLeft=LabelFrame(frame,text="MEMBER INFORMATION",bg="#355070",fg="white",bd=12,relief=RIDGE,font=("times new roman",12,"bold"))
        DataFrameLeft.place(x=0,y=5,width=560,height=170)


        lblv_no=Label(DataFrameLeft,bg="#355070",fg="white",text="🟈 First Name :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=1,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.firstname_var,width=17)
        txtv_no.grid(row=1,column=1)


        lblv_no=Label(DataFrameLeft,bg="#355070",fg="white",text="🟈 Last Name :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=2,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.lastname_var,width=17)
        txtv_no.grid(row=2,column=1)


        lblv_no=Label(DataFrameLeft,bg="#355070",fg="white",text="🟈 Vehicle Number :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=3,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.vehiclenumber_var,width=17)
        txtv_no.grid(row=3,column=1)


        lblv_no=Label(DataFrameLeft,bg="#355070",fg="white",text="🟈 Vehicle Name :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=4,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.vehiclename_var,width=17)
        txtv_no.grid(row=4,column=1)


        lblv_no=Label(DataFrameLeft,bg="#355070",fg="white",text="🟈 Mobile :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=1,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.mobile_var,width=25)
        txtv_no.grid(row=1,column=3)


        lblPayment_mode=Label(DataFrameLeft,bg="#355070",fg="white",text="🟈 Location :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblPayment_mode.grid(row=2,column=2,sticky=W)

        comPayment_mode=ttk.Combobox(DataFrameLeft,font=("times new roman",10,"bold"),textvariable=self.location_var,width=24,state="readonly")
        ...
        lblv_no=Label(DataFrameLeft,bg="#355070",fg="white",text="🟈 Slot no :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=3,column=2,sticky=W)

        comv_no=ttk.Combobox(DataFrameLeft,font=("times new roman",10,"bold"),textvariable=self.slotno_var,width=24,state="readonly")
        comv_no["value"]=[str(i) for i in range(1, 101)]
        comv_no.grid(row=3,column=3)

        lblv_no=Label(DataFrameLeft,bg="#355070",fg="white",text="🟈 Vehicle Type :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=4,column=2,sticky=W)

        comv_no=ttk.Combobox(DataFrameLeft,font=("times new roman",10,"bold"),textvariable=self.vehicletype_var,width=24,state="readonly")
        comv_no["value"]=("🏍","🛺","🚗","🚛","🛒")
        ...
        DataFrameRight.place(x=565,y=5,width=450,height=270)
       
               #========================BUTTONS FRAME========================================

        Framebutton=Frame(self.root,bd=12,relief=RIDGE,padx=0,bg="blue")
        Framebutton.place(x=47,y=580,width=1057,height=53)

        btnAddData=Button(Framebutton,command=self.add_data,text="BOOK SLOT",font=("arial",10,"bold"),width=25,bg="#2F3651",fg="white")
        btnAddData.grid(row=0,column=0,sticky=W)


        btnAdd=Button(Framebutton,command=self.iExit,text="EXIT",font=("arial",10,"bold"),width=25,bg="#2F3651",fg="white")
        btnAdd.grid(row=0,column=1,padx=1)

        btnUpdate=Button(Framebutton,command=self.update,text="UPDATE",font=("arial",10,"bold"),width=25,bg="#2F3651",fg="white")
        ...
        btnReset=Button(Framebutton,command=self.reset_data,text="RESET",font=("arial",10,"bold"),width=25,bg="#2F3651",fg="white")
        btnReset.grid(row=0,column=3,padx=1)

        btnAddData=Button(Framebutton,text="SLOT",command=self.update_statusss,font=("arial",10,"bold"),width=22,bg="#2F3651",fg="white")
        ...
        self.table_frame.place(x=650,y=285,width=420,height=230)
...
class Manager_Login_Window:
    def __init__(self,root):
        ...
        frame.place(x=380,y=180,width=340,height=400)
...
class FileComplaint:
    def __init__(self,root):
        ...
        frame.place(x=360,y=200,width=515,height=310)
        ...
        DataFrameLeft.place(x=0,y=5,width=470,height=270)
        ...
        Framebutton=Frame(self.root,bd=8,relief=RIDGE,padx=0,bg="powder blue")
        Framebutton.place(x=490,y=540,width=251,height=49)

        btnAddData=Button(Framebutton,command=self.adda_data,text="REGISTER COMPLAINT",font=("arial",11,"bold"),width=25,bg="#348781",fg="white")
        btnAddData.grid(row=0,column=0,sticky=W)
...
class Parkometer:
    def __init__(self,root):
        ...
        frame=Frame(self.root,bd=12,relief=RIDGE,padx=00,bg="#07161B")
        frame.place(x=25,y=130,width=1100,height=315)

        #================DataFrameLeft==================

        DataFrameLeft=LabelFrame(frame,text="MEMBER INFORMATION",bg="#3d737f",fg="#CEC7BF",bd=12,relief=RIDGE,font=("Display",12,"bold"))
        DataFrameLeft.place(x=2,y=5,width=505,height=282)

        lblMember=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Slot NO.",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblMember.grid(row=0,column=0,sticky=W)

        comMember=ttk.Combobox(DataFrameLeft,textvariable=self.selected_slot,font=("times new roman",10,"bold"),width=14,state="readonly")
        comMember["value"]=[str(i) for i in range(1, 101)]
        comMember.grid(row=0,column=1)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 First Name :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=1,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.firstname_var,width=17)
        txtv_no.grid(row=1,column=1)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Last Name :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=2,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.lastname_var,width=17)
        txtv_no.grid(row=2,column=1)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Vehicle Number :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=3,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.vehiclenumber_var,width=17)
        txtv_no.grid(row=3,column=1)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Vehicle Name :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=4,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.vehiclename_var,width=17)
        txtv_no.grid(row=4,column=1)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Address :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=5,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.address_var,width=17)
        txtv_no.grid(row=5,column=1)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Mobile :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=6,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.mobile_var,width=17)
        txtv_no.grid(row=6,column=1)

        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Bill Amount :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=7,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.billamount_var,width=17)
        txtv_no.grid(row=7,column=1)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Vehicle Type :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=0,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.vehicletype_var,width=17)
        txtv_no.grid(row=0,column=3)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Parking Time :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=1,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.parkingtime_var,width=17)
        txtv_no.grid(row=1,column=3)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Parkoff Time :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=2,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.parkofftime_var,width=17)
        txtv_no.grid(row=2,column=3)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Parking Date :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=3,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.parkingdate_var,width=17)
        txtv_no.grid(row=3,column=3)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Charges :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=4,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.charges_var,width=17)
        txtv_no.grid(row=4,column=3)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Slot Status :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=5,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.slotstatus_var,width=17)
        txtv_no.grid(row=5,column=3)


        lblv_no=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Slot Area :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=6,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.slotarea_var,width=17)
        txtv_no.grid(row=6,column=3)


        lblPayment_mode=Label(DataFrameLeft,bg="#3d737f",fg="#EDC18D",text="🟈 Slot Pic",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblPayment_mode.grid(row=7,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.slot_status_var,width=17)
        txtv_no.grid(row=7,column=3)
        ...
        #==============================DataFrame Right=================================
        DataFrameRight=LabelFrame(frame,text="VEHICLE INFORMATION",bg="#3d737f",fg="#CEC7BF",bd=12,relief=RIDGE,font=("Display",9,"bold"))
        DataFrameRight.place(x=510,y=5,width=283,height=282)

        
        self.txtBox=Text(DataFrameRight, font=("Courier new",9,"bold"),width=21,height=14,padx=3,pady=6)
        self.txtBox.grid(row=0,column=2)
        ...
        listBox=Listbox(DataFrameRight,font=("Arial CYR",7,"bold"),width=18,height=20)
        listBox.bind("<<ListboxSelect>>",SelectVehicles)
        listBox.grid(row=0,column=0,padx=4)
        ...
        # Create a label to display the row count
        frame=LabelFrame(frame,bd=12,relief=RIDGE,padx=00,bg="#3d737f")
        frame.place(x=880,y=5,width=183,height=75)

        l=Label(frame,bg="#4d737f",fg="WHITE",relief=RIDGE,font=("Lemon tuesday",31), text='     00     ',padx=00,pady=00)
        l.grid(row=4,column=0)


        self.table_frame = Frame(self.root,bd=5,bg="black")
        self.table_frame.place(x=830,y=230,width=280,height=195)

        

        #========================BUTTONS FRAME========================================

        Framebutton=Frame(self.root,bd=7,relief=RIDGE,padx=00,bg="powder blue")
        Framebutton.place(x=50,y=455,width=1040,height=41)

        btnAddData=Button(Framebutton,command=self.adda_data,text="Add Data",font=("arial",9,"bold"),width=23,bg="#348781",fg="white")
        btnAddData.grid(row=0,column=0,sticky=W)

        btnAddData=Button(Framebutton,command=self.showData,text="Show Data",font=("arial",9,"bold"),width=23,bg="#FF8674",fg="white")
        btnAddData.grid(row=0,column=1)

        btnAddData=Button(Framebutton,command=self.update,text="Update",font=("arial",9,"bold"),width=23,bg="#6CD300",fg="white")
        btnAddData.grid(row=0,column=2)

        btnAddData=Button(Framebutton,command=self.delete,text="Delete",font=("arial",9,"bold"),width=23,bg="#0AFFFF",fg="white")
        btnAddData.grid(row=0,column=3)

        btnAddData=Button(Framebutton,text="Reset",command=self.reset,font=("arial",9,"bold"),width=23,bg="#2C3539",fg="white")
        btnAddData.grid(row=0,column=4)

        btnAddData=Button(Framebutton,text="Exit",command=self.iExit,font=("arial",9,"bold"),width=23,bg="#B87333",fg="white")
        btnAddData.grid(row=0,column=5)

        Framebutton1=Frame(self.root,bd=7,relief=RIDGE,padx=00,bg="powder blue")
        Framebutton1.place(x=930,y=510,width=200,height=126)

        btnAddData=Button(Framebutton1,text="Members",command=self.allmembers,font=("arial",10,"bold"),width=22,bg="blue",fg="white")
        btnAddData.grid(row=0,column=0)

        btnAddData=Button(Framebutton1,text="Slot Availability",command=self.update_status,font=("arial",10,"bold"),width=22,bg="black",fg="white")
        btnAddData.grid(row=1,column=0)

        btnAddData=Button(Framebutton1,text="Complaints",command=self.cuscomplaint,font=("arial",10,"bold"),width=22,bg="#FF8674",fg="white")
        btnAddData.grid(row=2,column=0)

        btnAddData=Button(Framebutton1,text="Slot Bookings",command=self.slotbookingss,font=("arial",10,"bold"),width=22,bg="#348781",fg="white")
        ...
        FrameDetails=Frame(self.root,bd=12,relief=RIDGE,padx=00,bg="#07161B")
        FrameDetails.place(x=25,y=510,width=900,height=195)

        Table_frame=Frame(FrameDetails,bd=6,relief=RIDGE,bg="powder blue")
        Table_frame.place(x=0,y=2,width=875,height=170)
    ...
    def adda_data(self):
        ...
        count = my_cursor.fetchone()[0]
        # Update the label to display the count
        frame=Frame(self.root,relief=RIDGE,padx=0,bg="#3d737f")
        frame.place(x=930,y=159,width=153,height=51)
        frame1=LabelFrame(frame,bd=0,relief=RIDGE,padx=30,bg="#48416C")
        frame1.place(x=910,y=5,width=210,height=75)
        l=Label(frame,bg="#3d737f",fg="WHITE",relief=RIDGE,font=("Lemon tuesday",30), text='00',padx=40)
        l.grid(row=1,column=1,sticky=W)
        l.config(text=f' {  100 - count   }  ')
        # Close the database connection
        messagebox.showinfo("Success","Member Has been inserted successfully")
    ...
    def delete(self):
        if self.firstname_var.get()=="" or self.vehiclenumber_var.get()=="":
            ...
            count = my_cursor.fetchone()[0]
            # Update the label to display the count
            frame=Frame(self.root,relief=RIDGE,padx=00,bg="#3d737f")
            frame.place(x=930,y=159,width=153,height=51)
            frame1=LabelFrame(frame,bd=12,relief=RIDGE,padx=30,bg="#48416C")
            frame1.place(x=910,y=5,width=210,height=75)
            l=Label(frame,bg="#3d737f",fg="WHITE",relief=RIDGE,font=("Lemon tuesday",30), text='   00   ',padx=40)
            l.grid(row=1,column=1,sticky=W)
            l.config(text=f' {  100 - count   }  ')
...
#===============================================================slot==========================================================================================
    ...
    def display_table(self):
        ...
        for i, row in enumerate(rows, start=1):
            slot_id, slot_status = row
            label = Label(self.table_frame,bg="#07161B",fg="white" ,text=f'{slot_id}:{slot_status}',font=("times new roman",7), padx=00, pady=00)
            label.grid(row=(i - 1) // 10, column=(i - 1) % 10)        
...
class NewMembers:
    def __init__(self,root):
        ...
        frame=Frame(self.root,bd=12,relief=RIDGE,padx=10,bg="#48416C")
        frame.place(x=270,y=170,width=545,height=260)

        #================DataFrameLeft==================

        DataFrameLeft=LabelFrame(frame,text="MEMBER INFORMATION",bg="#0AAFFF",fg="yellow",bd=12,relief=RIDGE,font=("times new roman",12,"bold"))
        DataFrameLeft.place(x=0,y=5,width=500,height=225)



        lblv_no=Label(DataFrameLeft,bg="#0AAFFF",text="🟈 First Name :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=1,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.firstname_var,width=17)
        txtv_no.grid(row=1,column=1)


        lblv_no=Label(DataFrameLeft,bg="#0AAFFF",text="🟈 Last Name :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=2,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.lastname_var,width=17)
        txtv_no.grid(row=2,column=1)


        lblv_no=Label(DataFrameLeft,bg="#0AAFFF",text="🟈 Vehicle Number :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=3,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.vehiclenumber_var,width=17)
        txtv_no.grid(row=3,column=1)


        lblv_no=Label(DataFrameLeft,bg="#0AAFFF",text="🟈 Vehicle Name :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=4,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.vehiclename_var,width=17)
        txtv_no.grid(row=4,column=1)


        lblv_no=Label(DataFrameLeft,bg="#0AAFFF",text="🟈 Address :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=5,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.address_var,width=17)
        txtv_no.grid(row=5,column=1)


        lblv_no=Label(DataFrameLeft,bg="#0AAFFF",text="🟈 Mobile :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=6,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.mobile_var,width=17)
        txtv_no.grid(row=6,column=1)


        lblv_no=Label(DataFrameLeft,bg="#0AAFFF",text="🟈 Vehicle Type :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=1,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.vehicletype_var,width=17)
        txtv_no.grid(row=1,column=3)


        lblv_no=Label(DataFrameLeft,bg="#0AAFFF",text="🟈 Total Duration :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=2,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.paymentmode_var,width=17)
        txtv_no.grid(row=2,column=3)


        lblv_no=Label(DataFrameLeft,bg="#0AAFFF",text="🟈 Parking Date :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=3,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.parkingdate_var,width=17)
        txtv_no.grid(row=3,column=3)


        lblv_no=Label(DataFrameLeft,bg="#0AAFFF",text="🟈 Charges :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=4,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.charges_var,width=17)
        txtv_no.grid(row=4,column=3)


        lblv_no=Label(DataFrameLeft,bg="#0AAFFF",text="🟈 Slot Area :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=5,column=2,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.slotarea_var,width=17)
        txtv_no.grid(row=5,column=3)
        ...
        Framebutton=Frame(self.root,bd=7,relief=RIDGE,padx=0,pady=1,bg="powder blue")
        Framebutton.place(x=180,y=450,width=718,height=42)

        btnAddData=Button(Framebutton,command=self.adda_data,text="Add Data",font=("arial",9,"bold"),width=16,bg="#348781",fg="white")
        btnAddData.grid(row=0,column=0,sticky=W)

        btnAddData=Button(Framebutton,command=self.showData,text="Show Data",font=("arial",9,"bold"),width=15,bg="#FF8674",fg="white")
        btnAddData.grid(row=0,column=1)

        btnAddData=Button(Framebutton,command=self.update,text="Update",font=("arial",9,"bold"),width=15,bg="#6CD300",fg="white")
        btnAddData.grid(row=0,column=2)

        btnAddData=Button(Framebutton,command=self.delete,text="Delete",font=("arial",9,"bold"),width=15,bg="#0AFFFF",fg="white")
        btnAddData.grid(row=0,column=3)

        btnAddData=Button(Framebutton,text="Reset",command=self.reset,font=("arial",9,"bold"),width=15,bg="#2C3539",fg="white")
        btnAddData.grid(row=0,column=4)

        btnAddData=Button(Framebutton,text="Exit",command=self.iExit,font=("arial",9,"bold"),width=16,bg="#B87333",fg="white")
        btnAddData.grid(row=0,column=5)
...
#=====================information frame================
        ...
        FrameDetails=Frame(self.root,bd=12,relief=RIDGE,padx=0,bg="#48416C")
        FrameDetails.place(x=180,y=510,width=718,height=155)

        Table_frame=Frame(FrameDetails,bd=6,relief=RIDGE,bg="powder blue")
        Table_frame.place(x=0,y=0,width=695,height=130)
...
class BookingsSlot:
    def __init__(self,root):
        ...
        Framebutton=Frame(self.root,bd=12,relief=RIDGE,padx=0,bg="blue")
        Framebutton.place(x=280,y=510,width=548,height=57)
        ...
        #============tabel frame search system=====
        FrameDetails=Frame(self.root,bd=12,relief=RIDGE,padx=00,bg="#07161B")
        FrameDetails.place(x=70,y=170,width=1000,height=330)
        
        Table_Frame=Frame(FrameDetails,relief=RIDGE)
        Table_Frame.place(x=0,y=2,width=975,height=305)
        ...
        self.room_table.column("firstname",width=30)
...
class CustomerComplaint:
    def __init__(self,root):
        ...
        frame=Frame(self.root,bd=12,relief=RIDGE,padx=10,bg="#436372")
        frame.place(x=350,y=150,width=475,height=265)

        #================DataFrameLeft==================

        DataFrameLeft=LabelFrame(frame,text="FILL YOUR INFORMATION",bg="#fcd7b6",fg="maroon",bd=12,relief=RIDGE,font=("times new roman",11,"bold"))
        DataFrameLeft.place(x=0,y=5,width=430,height=230)


        lblv_no=Label(DataFrameLeft,bg="#fcd7b6",text="🟈 First Name :",font=("times new roman",11,"bold"),padx=2,pady=6)
        lblv_no.grid(row=1,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",11,"bold"),textvariable=self.firstname_var,width=29)
        txtv_no.grid(row=1,column=1)


        lblv_no=Label(DataFrameLeft,bg="#fcd7b6",text="🟈 Last Name :",font=("times new roman",11,"bold"),padx=2,pady=6)
        lblv_no.grid(row=2,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",11,"bold"),textvariable=self.lastname_var,width=29)
        txtv_no.grid(row=2,column=1)


        lblv_no=Label(DataFrameLeft,bg="#fcd7b6",text="🟈 Vehicle Number :",font=("times new roman",11,"bold"),padx=2,pady=6)
        lblv_no.grid(row=3,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",11,"bold"),textvariable=self.vehiclenumber_var,width=29)
        txtv_no.grid(row=3,column=1)


        lblv_no=Label(DataFrameLeft,bg="#fcd7b6",text="🟈 Vehicle Name :",font=("times new roman",11,"bold"),padx=2,pady=6)
        lblv_no.grid(row=4,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",11,"bold"),textvariable=self.vehiclename_var,width=29)
        txtv_no.grid(row=4,column=1)


        lblv_no=Label(DataFrameLeft,bg="#fcd7b6",text="🟈 Mobile :",font=("times new roman",11,"bold"),padx=2,pady=6)
        lblv_no.grid(row=5,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",11,"bold"),textvariable=self.mobile_var,width=29)
        txtv_no.grid(row=5,column=1)

        lblv_no=Label(DataFrameLeft,bg="#fcd7b6",text="🟈 Complaint :",font=("times new roman",11,"bold"),padx=2,pady=6)
        lblv_no.grid(row=6,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",11,"bold"),textvariable=self.billamount_var,width=29)
        txtv_no.grid(row=6,column=1)
        ...
        Framebutton.place(x=430,y=425,width=315,height=57)

        btnAddData=Button(Framebutton,command=self.iExit,text="EXIT",font=("arial",11,"bold"),width=15,bg="#348781",fg="white")
        btnAddData.grid(row=0,column=0,sticky=W)

        btnAddData=Button(Framebutton,command=self.delete,text="DELETE",font=("arial",11,"bold"),width=15,bg="#348781",fg="white")
        btnAddData.grid(row=0,column=1,sticky=W)
        ...
        FrameDetails=Frame(self.root,bd=12,relief=RIDGE,padx=0,bg="#48416C")
        FrameDetails.place(x=250,y=500,width=675,height=175)

        Table_frame=Frame(FrameDetails,bd=6,relief=RIDGE,bg="powder blue")
        Table_frame.place(x=0,y=2,width=650,height=145)
...
class TwoWheelerMembership:
    def __init__(self,root):
        ...
        frame=Frame(self.root,bd=12,relief=RIDGE,padx=0,bg="#48416C")
        frame.place(x=260,y=170,width=605,height=260)

        #================DataFrameLeft==================

        DataFrameLeft=LabelFrame(frame,text="MEMBER INFORMATION",bg="#0AAFFF",fg="yellow",bd=12,relief=RIDGE,font=("times new roman",12,"bold"))
        DataFrameLeft.place(x=5,y=5,width=500,height=225)
        ...
        #==============================DataFrame Right=================================
        DataFrameRight=LabelFrame(frame,text="SELECT",bg="powder blue",fg="green",relief=RIDGE,font=("times new roman",10,"bold"))
        DataFrameRight.place(x=510,y=5,width=70,height=90)
        ...
        listBox=Listbox(DataFrameRight,font=("Arial CYR",9,"bold"),width=10,height=10)
        listBox.bind("<<ListboxSelect>>",SelectVehicles)
        ...
        Framebutton=Frame(self.root,bd=12,relief=RIDGE,padx=00,bg="powder blue")
        Framebutton.place(x=440,y=440,width=235,height=53)

        btnAddData=Button(Framebutton,command=self.adda_data,text="APPLY",font=("arial",10,"bold"),width=25,bg="#348781",fg="white")
        btnAddData.grid(row=0,column=0,sticky=W)
...
class TroleyMembership:
    def __init__(self,root):
        ...
        lblv_no=Label(DataFrameLeft,bg="#0AAFFF",text="🟈 Last Name :",font=("times new roman",10,"bold"),padx=2,pady=6)
        lblv_no.grid(row=2,column=0,sticky=W)
        txtv_no=Entry(DataFrameLeft,font=("arial",10,"bold"),textvariable=self.lastname_var,width=29)
        txtv_no.grid(row=2,column=1)
